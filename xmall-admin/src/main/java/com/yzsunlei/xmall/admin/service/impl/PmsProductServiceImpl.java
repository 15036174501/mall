...
import com.yzsunlei.xmall.admin.dao.*;
...
import com.yzsunlei.xmall.db.mapper.*;
...
public class PmsProductServiceImpl implements PmsProductService {
    ...
    @Autowired
    private PmsProductExpandMapper productExpandMapper;
    @Autowired
    ...
    @Override
    public List<PmsProductExpand> getGoodsList() {
        return productExpandMapper.getGoodsList();
    }

    @Override
    public List getGoodsDetailAll(Long id) {
        return productExpandMapper.getGoodsDetailAll(id);
    }
