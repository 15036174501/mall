...
import com.yzsunlei.xmall.db.mapper.SmsHomeAdvertiseExpandMapper;
...
public class SmsHomeAdvertiseServiceImpl implements SmsHomeAdvertiseService {
    ...
    @Autowired
    private SmsHomeAdvertiseExpandMapper advertiseMapperExpand;
    ...
    @Override
    public List<SmsHomeAdvertiseExpand> listHomeAdvertise(Integer type) {
        return advertiseMapperExpand.listHomeAdvertise(type);
    }
}
